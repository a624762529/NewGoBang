...
void TcpCommunication::setReadCallBack
      (function<void(char*,int,void *,TcpCommunication *)> read_cb,
       void *read_arg)
{
...
void TcpCommunication::setWriteCallBack
     (function<void (void *arg,TcpCommunication *tcpCon)> write_cb ,
      void *write_arg)
{
...
void TcpCommunication::setExpCallBack
     (function<void (char*,int,void *)>  exp_cb,
      void *exp_arg)
{
...
void TcpCommunication::closeCommunication()
{
    ...
    doReadOver();
    doWriteOver();
    m_read_callback(nullptr,0,m_read_arg,
                    reinterpret_cast<TcpCommunication*>(this));
}
...
void TcpCommunication::setWriteInfoLen(int len)
{
    doWriteOver();
